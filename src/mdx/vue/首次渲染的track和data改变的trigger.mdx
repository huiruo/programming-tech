...
### B-2.如图：可见vnode构建的时候会触发handler的get
...
<ImageRender alt='test' path='/vue/vue3-构建的时候触发get.png' />

## C.data改变-->set-->trigger(触发器)
### C-1.trigger 函数
<CodeBlock>
```js
...
### C-2.trigger-->triggerEffects-->triggerEffect
<CodeBlock>
```js
